    ...
    <div class="header-content-right">
      ...
      <div class="header-element">
        ...
        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
          <div class="d-flex align-items-center">
            <div class="me-sm-2 me-0">
              <img src="../assets/modulo/usuario/perfil/<?php echo $_SESSION['user_imagen']; ?>" alt="img" width="32" height="32" class="rounded-circle" onerror="this.src='../assets/modulo/usuario/perfil/no-perfil.jpg';" />
            </div>
        ...
        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
          <li>
            <a class="dropdown-item d-flex" href="usuario.php"><i class="ti ti-user-circle fs-18 me-2 op-7"></i>Profile</a>
          </li>          
          <li>
            <a class="dropdown-item d-flex" href="empresa.php"><i class="ti ti-adjustments-horizontal fs-18 me-2 op-7"></i>Empresa</a>
          </li>          
          <li>
            <a class="dropdown-item d-flex" href="https://wa.link/oetgkf" target="_blank"><i class="ti ti-headset fs-18 me-2 op-7"></i>Soporte</a>
          </li>
          <li>
            <a class="dropdown-item d-flex text-danger" href="../ajax/usuario.php?op=salir"><i class="ti ti-logout fs-18 me-2 op-7"></i>Salir</a>
          </li>
        </ul>
      </div>
      <!-- End::header-element -->
