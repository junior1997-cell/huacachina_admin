...
function listar() {
	tabla_usuario = $('#tabla-usuario').dataTable({
		...
		buttons: [
			...
			{ extend: 'excel', exportOptions: { columns: [1, 2, 3, 4, 5, 6], }, title: 'Lista de usuarios', text: `<i class="far fa-file-excel fa-lg" ></i>`, className: "btn btn-outline-success btn-wave ", footer: false, },
